...
class SearchAppBarState extends State<SearchAppBarWidget> {
    ...
    return new PreferredSize(
        child: new Stack(
          children: <Widget>[
            new Offstage(
              offstage: false,
              child: buildAppBar(context , '', widget.backgroundColor, leading: widget.leading),
            ),
            new Offstage(
                offstage: false,
                child: Container(
                    padding: const EdgeInsets.only(left: 50.0, top: 26.0),
                    child: new TextField(
  ...
  static Widget buildAppBar(BuildContext context, String text, Color backgoundcolor,
      {
